...
def run(args):
    ...
    """
    if args.bigfile:
        server.cmd('cd .. ; ./server -s 10.1.0.1:8080 -p fileexchange --multipath --rcvd-threshold 50  --max-bidi-remote 700000 --scheduler lrtt2 --timeout 30000 --ack-eliciting-timer 25 > ./experiment5/server_out &')
    else:
        server.cmd('cd .. ; ./server -s 10.1.0.1:8080 -p fileexchange --multipath --rcvd-threshold 50  --max-bidi-remote 7000 --scheduler lrtt2 --timeout 30000 --ack-eliciting-timer 25 > ./experiment5/server_out &')
    """
    server.cmd('cd .. ; ./server -s 10.1.0.1:8080 -p fileexchange --multipath --rcvd-threshold 25 --max-bidi-remote 700000 --scheduler lrtt2 --timeout 30000 --ack-eliciting-timer 25 > ./experiment5/server_out &')
    #server.cmd('cd .. ; ./server -s 10.1.0.1:8080 -p fileexchange --rcvd-threshold 250000 --max-bidi-remote 7000 --scheduler normal --timeout 30000 --ack-eliciting-timer 2500000 > ./experiment5/server_out &')


    router = net['r0']
    info('Starting shutdown thread\n')
    s4 = net['s4']
    t = Thread(target=shutdown_link, args=(router,s4,True,))
    t.start()
    ...
    """
    if args.bigfile:
        client.cmd('cd .. ; ./client -s 10.1.0.1:8080 -p fileexchange --multipath -A 10.0.0.1:5050 -A 10.0.1.1:3355 --file bigfile -n 80 --rcvd-threshold 25 --time 200 --ack-eliciting-timer 25  --scheduler lrtt2 --timeout 30000 > {}'.format(args.file))
    else:
        client.cmd('cd .. ; ./client -s 10.1.0.1:8080 -p fileexchange --multipath -A 10.0.0.1:5050 -A 10.0.1.1:3355 --file file -n 80 --rcvd-threshold 25 --time 200 --ack-eliciting-timer 25  --scheduler lrtt2 --timeout 30000 > {}'.format(args.file))
    """

    client.cmd('cd .. ; ./client -s 10.1.0.1:8080 -p fileexchange --multipath -A 10.0.0.1:5050 -A 10.0.1.1:3355 --file bigfile -n 80 --rcvd-threshold 25 --time 200 --ack-eliciting-timer 25  --scheduler lrtt2 --timeout 30000 > {}'.format(args.file))
    #client.cmd('cd .. ; ./client -s 10.1.0.1:8080 -p fileexchange -A 10.0.0.1:5050 --file file -n 80 --rcvd-threshold 2500000 --time 200 --ack-eliciting-timer 25000000  --scheduler normal --timeout 30000 > {}'.format(args.file))    
    sleep(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--file', type=str, help='Client output file', required=False, default='./experiment5/outputQuic')
    ...
    parser.add_argument('-big', '--bigfile', type=bool, help='Whether to use a big file or not', required=False, default=False)
    parser.add_argument('-cut', '--cut', type=bool, help='Whether to cut link or not', required=False, default=False)
