...
def run(args):
    ...
    #server.cmd('tshark -i h3-eth0 -w capture_server0_tcp.pcapng &')
    #server.cmd('cd .. ; ./HTTP2custom/serverHTTP2custom -s 10.1.0.1:8080 -s 10.1.0.1:8081 -p fileexchange &')
    server.cmd('cd .. ; ./HTTP2/serverHTTP2 -s 10.1.0.1:8080 -p fileexchange &')
    ...
    #client.cmd('cd .. ; ./HTTP2custom/clientHTTP2custom -s 10.1.0.1:8080 -s 10.1.0.1:8081 -p fileexchange -A 10.0.0.1 -A 10.0.1.1 --file bigfile -n 80 --rtime 200 --time 200 --ptimer 10 > {}'.format(args.file))
    client.cmd('cd .. ; ./HTTP2/clientHTTP2 -s 10.1.0.1:8080 -p fileexchange -A 10.0.0.1 --file file -n 80 --rtime 100000 --time 200 --ptimer 0 > {}'.format(args.file))    
    sleep(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--file', type=str, help='Client output file', required=False, default='./experiment5/outputHTTP')
