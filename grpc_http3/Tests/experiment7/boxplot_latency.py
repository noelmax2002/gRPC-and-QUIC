...
folder1 = 'tcp_only_latency' 
folder2 = 'tcp_improved_latency' 
folder3 = 'quic_only_latency'  
folder4 = 'mpquic_backup_improved_latency'
folder5 = 'mpquic_duplicate_latency'
...
plt.savefig('Boxplot_latency.pdf')
plt.show()
